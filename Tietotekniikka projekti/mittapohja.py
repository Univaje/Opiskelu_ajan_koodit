...
from qt_utils import defaultItem, tkComboBox
...
class Mittapohja():
  ...
  def luoTable(self, parent):
    ...
    self.twMittaukset.setColumnCount(3)
    self.twMittaukset.setHorizontalHeaderLabels(["Työkalu", "Nominaalimitta", "Toleranssi"])
    for i in range(3):
      self.twMittaukset.setCellWidget(i, 0, tkComboBox())
      self.twMittaukset.setItem(i, 1, defaultItem())
      self.twMittaukset.setItem(i, 2, defaultItem())
  ...
  def lisaaRivi(self):
    ...
    self.twMittaukset.setCellWidget(rowPosition, 0, tkComboBox(1,2,3))
    self.twMittaukset.setItem(rowPosition, 1, defaultItem())
    self.twMittaukset.setItem(rowPosition, 2, defaultItem())
