...
import { Teht34, TableRow } from './teht34'

// ÄLÄ aja tätä tiedostoa JEST:llä

export const renderTeht34 = (max_rows) => {
...
export const renderTeht36 = (max_rows) => {
  ...
  export const testTeht35 = () => {
    const max_rows = 6;
    renderTeht34(max_rows);
  ...
  export const testTeht36 = () => {
    const max_rows = 6;
    renderTeht36(max_rows);
